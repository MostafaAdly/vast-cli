...
function defaultPaint(tone, text) {
    if (tone === 'success')
...
export function createStatusBoard(rows, stream = process.stdout, paint = defaultPaint) {
...
//# sourceMappingURL=status-board.js.map