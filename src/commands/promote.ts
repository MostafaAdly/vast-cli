...
import {
  ...
  RELEASE_KINDS,
  type ReleaseKind,
} from '../utils/release-branch.js';
import { resolvePicks, type ResolvedPick } from '../utils/picks.js';
...
const defaultAnnounceDeps: AnnounceDeps = {
  readSlackToken,
  readSlackChannel,
  slackUserOverride,
...
export async function announceRelease(
  ...
  version: string,
  url: string | null,
  opts: { dryRun: boolean; picks?: ResolvedPick[] },
